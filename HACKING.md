...
hidden if the `programproject_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `programproject_DEVELOPER_MODE` to the configure
...
Runs the executable target `programproject_exe`.
